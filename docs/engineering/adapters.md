...
- **Local git.** Shipped as an **in-app source** (not an adapter — the app watches connected repos directly), see the [progression plan](../design/progression.md#planned-sources).
