...
typography:
  ...
  h3:      { fontFamily: "Teko", cqw: 2.8, weight: 700, lineHeight: 1.2, lower: true }
  quote-text:{ fontFamily: "Teko", cqw: 3.8, weight: 700, lineHeight: 1.15, tracking: "-0.02em", lower: true }
  h2:      { fontFamily: "Teko", cqw: 4.5, weight: 700, lineHeight: 1.1, tracking: "-0.02em", lower: true }
  stat-value:{ fontFamily: "Teko", cqw: 5.5, weight: 700, lineHeight: 1.0, tracking: "-0.04em" }
  h1:      { fontFamily: "Teko", cqw: 7.5, weight: 700, lineHeight: 0.9, tracking: "-0.03em", lower: true }
  fadelist-item:{ fontFamily: "Teko", cqw: 7.5, weight: 700, lineHeight: 1.0, tracking: "-0.03em", lower: true }
  quote-mark:{ fontFamily: "Teko", cqw: 10.0, weight: 700, lineHeight: 0.6 }
  fadelist-title:{ fontFamily: "Teko", cqw: 10.5, weight: 700, lineHeight: 0.9, tracking: "-0.04em", lower: true }
  display: { fontFamily: "Teko", cqw: 13.0, weight: 700, lineHeight: 0.88, tracking: "-0.04em", lower: true }
...
> Worklings portability override: normative typography tokens use locally shipped Teko 700 for display, Inter 400/700/900 for reading copy, and IBM Plex Mono 500 for chrome. The older Barlow references below describe the preset's intended condensed-weight relationship; Teko fulfills that role in this project.
